      ...
      <>
         <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center">
               <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                     {userCompletedLessons.length < 6 ? (
                        <>Suerte!</>
                     ) : userCompletedLessons.length < 12 ? (
                        <>Te falta poco!</>
                     ) : (
                        <>Lo lograste!</>
                     )}
               ...
               <div className="flext flex-col gap-2 text-end">
                  <p className="text-xl font-medium ">
                     {userCompletedLessons.length}/{totalLesssons}
                  </p>
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-200/20 rounded-full h-4">
               <div
                  className={`${userCompletedLessons.length === 12 ? "bg-green-500" : "bg-gradient-to-r from-blue-500 to-green-500"} h-4 rounded-full transition-all duration-500`}
                  style={{
                     width: `${(userCompletedLessons.length / 12) * 100}%`,
                  }}
               ></div>
            </div>
         </div>
